...
<script type="text/javascript" src=" {{ asset('plugin/funcionalidad/assets/js/js-citas-edit.js') }}"></script>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" >
			<div id="asignacion" >
				...
				<div class="row">
					<div class="col-lg-12">
						<h3 class="page-header">Edicion Cita 	| {{ $cita->nombre_p . ' ' . $cita->apellido_p}}</h3>
					</div>
				</div>
				<!-- /.row --> 
				{!! Form::open(['route' => ['admin.citas.update', $cita], 'method' => 'PUT', 'files' => true, 'id' => 'frm_filtro']) !!}
						...
						<div class="panel panel-success">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									{!! Form::select('nombre', [$cita->cedula_p => $cita->nombre_p . ' ' . $cita->apellido_p], [$cita->cedula_p], ['class' => 'form-control', 'required', 'placeholder' => 'Nombre', 'id' => 'nombre', 'name' => 'nombre']) !!}
								</div>
								<div class="form-group">
									{!! Form::label('cedula', 'Cedula') !!}
									{!! Form::text('cedula', $cita->cedula_p, ['class' => 'form-control', 'id' => 'cedula', 'name' => 'cedula', 'placeholder' => 'Cedula', 'readonly' => 'readonly']) !!}
								</div>
								<div class="form-group">
									{!! Form::label('estado', 'Estado') !!}
									{!! Form::select('estado', ['Cancelada' => 'Cancelada', 'Reprogramada' => 'Reprogramada', 'Asignada' => 'Asiganada'], $cita->estado, ['class' => 'form-control', 'required', 'placeholder' => 'Nombre', 'id' => 'estado', 'name' => 'estado']) !!}
								</div>
							</div>
						</div>  
					</div> 
										...
										<div class="row">
											<div class="col-lg-4">
												<div class="form-group">
													...
													{!! Form::select('especialidad', $especialidades, $cita->id_especialidad, ['class' => 'form-control', 'required', 'placeholder' => 'Cita', 'id' => 'especialidad', 'name' => 'especialidad']) !!}
												</div>
											</div>
												...
												<div class="col-lg-9">
													<div id="content">
														<div class="filtro">
															...
															{!! Form::label('mes', 'Mes') !!}
															{!! Form::select('periodo', $aux_periodo, $cita->id_periodo, ['class' => 'form-control', 'required', 'placeholder' => 'Cita', 'id' => 'periodo', 'name' => 'periodo', 'style' => 'width:140px;display:inline;', 'onchange' => 'filtrar()', 'onclick' => 'filtrar()']) !!}
															{!! Form::label('', '') !!}
															{!! Form::label('fecha_cita', 'Fecha Cita') !!}
															{!! Form::text('fecha_cita', $cita->fecha, ['class' => 'form-control', 'id' => 'fecha_cita', 'name' => 'fecha_cita', 'placeholder' => 'Fecha', 'style' => 'width:200px;display:inline; padding-right: 20px;']) !!}
