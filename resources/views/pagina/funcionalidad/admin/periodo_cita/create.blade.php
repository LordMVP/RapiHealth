...
<div class="funcionalidad" >
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Creacion Periodo Citas</h3>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-10 col-md-6">
					...
					{!! Form::open(['route' => 'admin.periodo_cita.store', 'method' => 'POST', 'files' => true]) !!}

					<div class="form-group">
						{!! Form::label('ano', 'Año') !!}
						{!! Form::select('ano', [date("Y") => date("Y"), date("Y")+1 => date("Y")+1, date("Y")+2 => date("Y")+2, date("Y")+3 => date("Y")+3, date("Y")+4 => date("Y")+4], null, ['class' => 'form-control', 'placeholder' => 'Seleccione Año', 'required', 'id' => 'ano', 'onchange' => 'fun_ano()', 'onclick' => 'fun_ano()']) !!}
					</div>
