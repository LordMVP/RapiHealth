...
<div class="funcionalidad">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Editar Medico - {!! $user->nombre . ' ' . $user->apellido!!}</h3>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-10 col-md-6">
					...
					{!! Form::open(['route' => ['admin.medicos.update', $user], 'method' => 'PUT', 'files' => true]) !!}
					...
					<div class="form-group">
						...
						{!! Form::select('especialidad[]', $especialidad, $user->especialidad, ['class' => 'form-control', 'multiple', 'required', 'id' => 'especialidad']) !!}
					</div>
