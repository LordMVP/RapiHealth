...
<div class="funcionalidad">
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Editar Paciente - {!! $user->nombre . ' ' . $user->apellido!!}</h3>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-10 col-md-6">
					...
					{!! Form::open(['route' => ['admin.pacientes.update', $user], 'method' => 'PUT', 'files' => true]) !!}
					...
					<div class="form-group">
						<input type="hidden" id="tipo" name="tipo" value="paciente">
					</div>
