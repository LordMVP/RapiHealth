...
{	
	...
	$.ajax({
		...
		type: "POST",
		dataType: "json",
		url: "ajax/ajax_paciente.php?action=listar",
				...
				if(data.length > 0){
					$.each(data, function(i,item){
						...
						html += '<tr>'
							...
							html += '<td><a  href="consultar-pacientes-detalles.php?cedula='+item.cedula+'" >   <span class="glyphicon glyphicon-trash"></span> Editar  </a> </td>'
